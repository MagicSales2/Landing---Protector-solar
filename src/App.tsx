        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="grid grid-cols-2 gap-2 max-w-md mx-auto lg:mx-0 pt-2 text-left">
              <div className="flex items-start gap-2 p-2 bg-white rounded-xl border border-slate-100 shadow-2xs">
      ...
      <section className="py-16 px-4 bg-white border-y border-slate-100">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-red-50/40 border border-red-100 space-y-3 shadow-2xs">
      ...
      <section id="planes-oferta" className="py-16 px-4 bg-white border-t border-slate-100">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            ...
            {/* Offer 1 Unit */}
            <div className="bg-white border rounded-2xl p-5 sm:p-6 flex flex-col justify-between transition-all hover:border-slate-300 shadow-2xs relative">
